...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yaml-mode ledger-mode persistent-scratch ox-reveal cyberpunk-theme color-theme-modern tao-theme punpun-theme omtose-phellack-theme peacock-theme darktooth-theme dracula-theme calfw geiser paredit circe elfeed magit helm-projectile helm org-gcal org-bullets dired+ web-mode py-autopep8 elpy fancy-narrow centered-window-mode yasnippet))))
